...
e.preventDefault; // evita el comportamineto de recargar la pagina 
 ...
 if(e.target.closest('a')){
    ...
    const categoriaActiva = e.target.closest('a').dataset.categorias; // importante poner siempre un dataset por que ayuda a poder manipular bien los elementos 
       ...
       galeria$2.dataset.categorias = categoriaActiva;
...
//   `; forma 1
   ...
   galeria$2.querySelector('.galeria__carousel-slides').innerHTML +=slider; 
...
const cgaleria = document.getElementById('galeria');

const cerrargaleria = ()=>{
console.log(galeria);


    cgaleria.classList.remove('galeria--active');
